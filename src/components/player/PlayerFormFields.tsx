    ...
    <div className="grid grid-cols-1 md:grid-cols-7 gap-4">
      ...
      <div className="md:col-span-2">
        ...
        <Input 
          ...
          onChange={e => onInputChange("line_1", e.target.value)} 
      ...
      <div className="md:col-span-4 space-y-4">
        <div>
          <Label className="mb-2 inline-block">In mặt lưng áo</Label>
          <div className="flex items-center space-x-2 mb-4">
            <Checkbox 
              id="backNumber" 
              checked={newPlayer.back_number || false} 
              onCheckedChange={checked => onInputChange("back_number", checked === true)} 
            />
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center space-x-2">
                <Checkbox 
                  ...
                  onCheckedChange={checked => onInputChange("chest_number", checked === true)} 
                />
              ...
              <div className="flex items-center space-x-2">
                <Checkbox 
                  ...
                  onCheckedChange={checked => onInputChange("pants_number", checked === true)} 
                />
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex items-center space-x-2">
              <Checkbox 
                ...
                onCheckedChange={checked => onInputChange("logo_chest_left", checked === true)} 
              />
            ...
            <div className="flex items-center space-x-2">
              <Checkbox 
                ...
                onCheckedChange={checked => onInputChange("logo_chest_right", checked === true)} 
              />
            ...
            <div className="flex items-center space-x-2">
              <Checkbox 
                ...
                onCheckedChange={checked => onInputChange("logo_chest_center", checked === true)} 
              />
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex items-center space-x-2">
              <Checkbox 
                ...
                onCheckedChange={checked => onInputChange("logo_sleeve_left", checked === true)} 
              />
            ...
            <div className="flex items-center space-x-2">
              <Checkbox 
                ...
                onCheckedChange={checked => onInputChange("logo_sleeve_right", checked === true)} 
              />
            ...
            <div className="flex items-center space-x-2">
              <Checkbox 
                ...
                onCheckedChange={checked => onInputChange("logo_pants", checked === true)} 
              />
