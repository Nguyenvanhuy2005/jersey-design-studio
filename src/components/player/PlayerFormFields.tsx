  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        <div>
          <Label htmlFor="number" className="text-sm">Số áo</Label>
          <Input
            id="number"
            placeholder="Số áo"
        ...
        <div className="space-y-1.5">
          <Label className="text-sm">In số áo & quần</Label>
          <div className="grid grid-cols-2 gap-2">
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="chest_number" className="text-sm">In số ngực</Label>
            </div>
            <div className="flex items-center space-x-2">
              <Checkbox
                id="pants_number"
              ...
              />
              <Label htmlFor="pants_number" className="text-sm">In số quần</Label>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-3">
        <div>
          <Label htmlFor="name" className="text-sm">Tên cầu thủ</Label>
          <Input
            id="name"
        ...
        <div>
          <Label className="text-sm">In chữ ngực</Label>
          <Input
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <Label htmlFor="uniform_type" className="text-sm">Loại quần áo</Label>
        ...
        <div>
          <Label htmlFor="size" className="text-sm">Kích cỡ</Label>
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-x-8 gap-y-2">
          <div className="flex items-center space-x-2">
            ...
            />
            <Label htmlFor="logo_chest_left" className="text-sm">Ngực trái</Label>
          </div>
          <div className="flex items-center space-x-2">
            <Checkbox
              id="logo_sleeve_left"
            ...
            />
            <Label htmlFor="logo_sleeve_left" className="text-sm">Tay trái</Label>
          </div>
          <div className="flex items-center space-x-2">
            <Checkbox
              id="logo_chest_right"
            ...
            />
            <Label htmlFor="logo_chest_right" className="text-sm">Ngực phải</Label>
          </div>
          <div className="flex items-center space-x-2">
            <Checkbox
            ...
            />
            <Label htmlFor="logo_sleeve_right" className="text-sm">Tay phải</Label>
          </div>
          <div className="flex items-center space-x-2">
            <Checkbox
            ...
            />
            <Label htmlFor="logo_chest_center" className="text-sm">Ngực giữa</Label>
          </div>
          <div className="flex items-center space-x-2">
            <Checkbox
              id="logo_pants"
            ...
            />
            <Label htmlFor="logo_pants" className="text-sm">Quần</Label>
          </div>
        </div>
      </div>
      ...
      {/* Kiểu in */}
      <div>
        <Label htmlFor="print_style" className="text-sm">Kiểu in</Label>
      ...
      <div className="flex justify-end space-x-2 pt-2">
        ...
        <Button type="button" size="sm" onClick={onAddOrUpdate}>
