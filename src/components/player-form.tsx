...
export function PlayerForm({
  ...
  const PlayerFormFields = () => <div className={cn("grid grid-cols-1 md:grid-cols-7 gap-4", isMobile ? "p-4" : "")}>
      <div className="md:col-span-2">
        <Label htmlFor="playerNumber">Số áo</Label>
        <Input id="playerNumber" type="text" value={newPlayer.number || ""} onChange={e => setNewPlayer(prev => ({
        ...prev,
      ...
      <div className="md:col-span-2">
        ...
        <Input id="line1" value={newPlayer.line_1 || ""} onChange={e => setNewPlayer(prev => ({
        ...prev,
      ...
      <div className="md:col-span-2">
        ...
        <Input id="line3" value={newPlayer.line_3 || ""} onChange={e => setNewPlayer(prev => ({
        ...prev,
      ...
      <div>
        ...
        <Select value={newPlayer.size} onValueChange={value => setNewPlayer(prev => ({
        ...prev,
        size: value as UniformSize
      }))}>
      ...
      <div className="md:col-span-2">
        ...
        <Select value={newPlayer.uniform_type || "player"} onValueChange={value => setNewPlayer(prev => ({
        ...prev,
      ...
      <div className="md:col-span-2">
        ...
        <Select value={newPlayer.print_style} onValueChange={value => setNewPlayer(prev => ({
        ...prev,
        print_style: value
      }))}>
      ...
      <div className="md:col-span-4 space-y-4">
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex items-center space-x-2">
              <Checkbox id="chestNumber" checked={newPlayer.chest_number || false} onCheckedChange={checked => setNewPlayer(prev => ({
              ...prev,
              chest_number: checked === true
            }))} />
              <Label htmlFor="chestNumber">In số ngực</Label>
            </div>
            <div className="flex items-center space-x-2">
              <Checkbox id="pantsNumber" checked={newPlayer.pants_number || false} onCheckedChange={checked => setNewPlayer(prev => ({
              ...prev,
              pants_number: checked === true
            }))} />
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex items-center space-x-2">
              <Checkbox id="logoChestLeft" checked={newPlayer.logo_chest_left || false} onCheckedChange={checked => setNewPlayer(prev => ({
              ...prev,
              logo_chest_left: checked === true
            }))} />
              <Label htmlFor="logoChestLeft">Logo ngực trái</Label>
            </div>
            <div className="flex items-center space-x-2">
              <Checkbox id="logoChestRight" checked={newPlayer.logo_chest_right || false} onCheckedChange={checked => setNewPlayer(prev => ({
              ...prev,
              logo_chest_right: checked === true
            }))} />
              <Label htmlFor="logoChestRight">Logo ngực phải</Label>
            </div>
            <div className="flex items-center space-x-2">
              <Checkbox id="logoChestCenter" checked={newPlayer.logo_chest_center || false} onCheckedChange={checked => setNewPlayer(prev => ({
              ...prev,
              logo_chest_center: checked === true
            }))} />
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex items-center space-x-2">
              <Checkbox id="logoSleeveLeft" checked={newPlayer.logo_sleeve_left || false} onCheckedChange={checked => setNewPlayer(prev => ({
              ...prev,
              logo_sleeve_left: checked === true
            }))} />
              <Label htmlFor="logoSleeveLeft">Logo tay trái</Label>
            </div>
            <div className="flex items-center space-x-2">
              <Checkbox id="logoSleeveRight" checked={newPlayer.logo_sleeve_right || false} onCheckedChange={checked => setNewPlayer(prev => ({
              ...prev,
              logo_sleeve_right: checked === true
            }))} />
              <Label htmlFor="logoSleeveRight">Logo tay phải</Label>
            </div>
            <div className="flex items-center space-x-2">
              <Checkbox id="logoPants" checked={newPlayer.logo_pants || false} onCheckedChange={checked => setNewPlayer(prev => ({
              ...prev,
              logo_pants: checked === true
            }))} />
      ...
      <div className="md:col-span-3">
        ...
        <Input id="playerNote" value={newPlayer.note || ""} onChange={e => setNewPlayer(prev => ({
        ...prev,
        note: e.target.value
  ...
  return <Card className={className}>
      <CardHeader>
        <div className="flex items-center justify-between">
          ...
          {isMobile && <Button onClick={() => setIsFormOpen(true)}>
              <Plus className="h-4 w-4 mr-1" /> Thêm cầu thủ
            </Button>}
        </div>
      </CardHeader>
      ...
      <CardContent className="space-y-4">
        {players.length > 0 ? <div className="grid gap-4">
