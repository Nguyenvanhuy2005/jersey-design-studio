...
export function Navbar() {
  ...
  const renderDesktopNav = () => <div className="flex items-center gap-2">
  ...
  const renderMobileNav = () => <div className="flex items-center gap-2">
  ...
  return <header className={`${WHITE_BG} shadow-sm`}>
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        <Link to="/" className="flex items-center gap-3">
          <img src="/lovable-uploads/22f702c3-6095-4e93-be50-75d861b70af2.png" alt="Easy Print Logo" className="h-12 w-auto object-contain" style={{
          filter: "drop-shadow(0 2px 8px rgba(0,0,0,0.2))"
        }} />
          <span className="font-bold text-xl tracking-tight text-black" style={{
